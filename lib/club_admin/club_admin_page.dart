...
import 'package:the_gfa/club_admin/make_payment/make_payment_page.dart';
...
String makePaymentTitle = "Make App Payment";
...
Color bluishColor = Color.fromRGBO(34, 84, 91, 1.0);
...
class MyClubAdminPageState extends State<MyClubAdminPage> {
            ...
            children: <Widget>[
              ...
              Material(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    fetchAndNavigateToMakePayments(context);
                  },
                  child: Align(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: bluishColor.withAlpha(80),
                            ),
                            child: IconButton(
                              icon: FaIcon(
                                FontAwesomeIcons.gg,
              ...
              if (widget.clubId == 'coventryphoenixfc') ...[
                Divider(
                  height: 5,
                  thickness: 0.5,
                  color: dividerColor.withOpacity(0.3),
  ...
  Future<void> fetchAndNavigateToMakePayments(BuildContext context) async {
    navigateToMakePayments(context, widget.clubId);
    setState(() {});
  }
}
...
Future navigateToMakePayments(BuildContext context, String clubId) async {
  Navigator.push(context, MaterialPageRoute(builder: (context) => ClubAppPaymentPage(clubId: clubId)));
}
