...
class _CreateSponsorsShoutOutSMPostState extends State<CreateSponsorsShoutOutSMPost> {
  ...
  _shareContent(GlobalKey boundaryKey) async {
    ...
    var storageRefLowRes = FirebaseStorage.instance.ref().child('${widget.clubId}/current_sponsor_event_banners/low_resolution/$fileNameLowRes');
    var storageRefHighRes = FirebaseStorage.instance.ref().child('${widget.clubId}/current_sponsor_event_banners/high_resolution/$fileNameHighRes');
