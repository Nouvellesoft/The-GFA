...
import 'package:the_gfa/club_admin/more_comm/modify_locations/remove_location_page.dart';

import '../../../bloc_navigation_bloc/navigation_bloc.dart';
import 'add_new_location_page.dart';

String acsTitle = 'Modify Match Locations';
String ancsTitle = 'Add New Match Location';
String rcsTitle = 'Remove Match Location(s)';
...
class TabviewLocationPage extends StatefulWidget implements NavigationStates {
  TabviewLocationPage({super.key});

  @override
  State<TabviewLocationPage> createState() => _TabviewLocationPageState();
}

class _TabviewLocationPageState extends State<TabviewLocationPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(acsTitle, style: GoogleFonts.jura(fontSize: 23, fontWeight: FontWeight.w800, color: Colors.white)),
        leading: IconButton(
