...
Future<void> getPastMatches(PastMatchesNotifier pastMatchesNotifier, ClubGlobalProvider clubGlobalProvider, String clubId) async {
  ...
  pastMatchesNotifier.updateClubIconFromProvider(clubGlobalProvider);
}
