...
String fieldsAnchorSnapshotIDTwo = "assists";
...
Future<void> getMostAssistsPlayersStatsAndInfo(MostAssistsPlayersStatsAndInfoNotifier mostAssistsPlayersStatsAndInfoNotifier, String clubId) async {
  // Get visibility data
  ...
  List<PlayersStatsAndInfo> mostAssistsPlayersStatsAndInfoList = playersTableSnapshot.docs
