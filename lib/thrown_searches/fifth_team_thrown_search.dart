...
Color cardBackgroundColor = const Color.fromRGBO(33, 28, 33, 1.0);
...
class MyFifthTeamClassSearch extends SearchDelegate {
  final List? all;
  final String clubId;

  final bool _isVisible = true;

  MyFifthTeamClassSearch({required this.clubId, required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all?.where((fifthTeamClass) => fifthTeamClass.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if (queryTech.isNotEmpty) {
      search = all?.where((fifthTeamClass) => fifthTeamClass.name.contains(queryTech)).toList();
    } else {
      search = all;
    }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          fifthTeamClassNotifier.currentFifthTeamClass = search[position];
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        ...
                                        image: CachedNetworkImageProvider(search[position].image),
                                        fit: BoxFit.cover)),
                              ),
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Text(search[position].positionPlaying,
