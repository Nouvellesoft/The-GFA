...
Color modalBackgroundColor = const Color.fromRGBO(36, 31, 37, 1.0);
Color materialBackgroundColor = Colors.transparent;
Color cardBackgroundColor = const Color.fromRGBO(36, 31, 37, 1.0);
Color splashColor = const Color.fromRGBO(36, 31, 37, 1.0);
...
class MySecondTeamClassSearch extends SearchDelegate {
  ...
  MySecondTeamClassSearch({required this.clubId, required this.all});
