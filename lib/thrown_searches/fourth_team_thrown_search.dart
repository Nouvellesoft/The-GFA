...
Color modalBackgroundColor = const Color.fromRGBO(22, 26, 24, 1.0);
Color materialBackgroundColor = Colors.transparent;
Color cardBackgroundColor = const Color.fromRGBO(22, 26, 24, 1.0);
Color splashColor = const Color.fromRGBO(22, 26, 24, 1.0);
...
class MyFourthTeamClassSearch extends SearchDelegate {
  final List? all;
  final String clubId;

  final bool _isVisible = true;

  MyFourthTeamClassSearch({required this.clubId, required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all?.where((fourthTeamClass) => fourthTeamClass.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if (queryTech.isNotEmpty) {
      search = all?.where((fourthTeamClass) => fourthTeamClass.name.contains(queryTech)).toList();
    } else {
      search = all;
    }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          fourthTeamClassNotifier.currentFourthTeamClass = search[position];
