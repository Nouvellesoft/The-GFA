...
Color cardBackgroundColor = const Color.fromRGBO(38, 37, 32, 1.0);
...
class MySixthTeamClassSearch extends SearchDelegate {
  final List? all;
  final String clubId;

  final bool _isVisible = true;

  MySixthTeamClassSearch({required this.clubId, required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all?.where((sixthTeamClass) => sixthTeamClass.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if (queryTech.isNotEmpty) {
      search = all?.where((sixthTeamClass) => sixthTeamClass.name.contains(queryTech)).toList();
    } else {
      search = all;
    }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          sixthTeamClassNotifier.currentSixthTeamClass = search[position];
