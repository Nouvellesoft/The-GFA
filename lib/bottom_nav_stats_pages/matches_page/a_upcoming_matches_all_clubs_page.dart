                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Center(
                      ...
                      children: [
                        Text(DateFormat('dd-MM-yyyy HH:mm:ss').format(upcomingMatchesForAllClubsNotifier.upcomingMatchesForAllClubsList[widget.index].matchDate!),
                  ...
                  children: [
                    Flexible(
                      child: Padding(
                        padding: const EdgeInsets.all(2.0),
                        child: Text(
                          'Competition: ${upcomingMatchesForAllClubsNotifier.upcomingMatchesForAllClubsList[widget.index].competition!}',
                          style: GoogleFonts.saira(
                            color: Colors.white,
                            fontSize: 11,
                            fontWeight: FontWeight.w400,
