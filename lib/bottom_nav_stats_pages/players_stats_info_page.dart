...
class _PlayersStatsAndInfoPageState extends State<PlayersStatsAndInfoPage> {
                                                        ...
                                                        child: Container(
                                                          ...
                                                          decoration: BoxDecoration(
                                                            image: DecorationImage(
                                                                ...
                                                                image: CachedNetworkImageProvider((topGoalsPlayersStatsAndInfoNotifier
                                                                    .topGoalsPlayersStatsAndInfoList[index].image)!),
                                                                fit: BoxFit.cover),
                                                      ...
                                                      Column(
                                                        children: [
                                                          ...
                                                          Text('"${coachesReviewsCommentNotifier.coachesReviewsCommentList[index].comment!}"',
                                                              style: GoogleFonts.iceberg(
                                                                  color: textColorFour, fontSize: 13, fontStyle: FontStyle.italic),
                                                    ...
                                                    children: <Widget>[
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            foundersReviewsCommentNotifier.foundersReviewsCommentList[index].name!
                                                                .replaceAll(" ", "\n"),
                                                            style: GoogleFonts.kottaOne(
                                                              color: keyTextColor,
                                                              fontSize: 25,
                              ...
                              Align(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (playerOfTheMonthStatsAndInfoNotifier.playerOfTheMonthStatsAndInfoList[index].playerPosition
                                            .toString()
                                            .toLowerCase() ==
                                        'gk') ...[
                                      Column(
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: Text(
                                                ...
                                                style: GoogleFonts.rubikMicrobe(
                                                    color: dialogColor, fontSize: 24, fontWeight: FontWeight.bold, height: 0.81),
                                                overflow: TextOverflow.ellipsis,
                                              ),
                                            ),
                                          ),
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: SizedBox(
                                                  width: MediaQuery.of(context).size.width * 0.35,
                                                  child: Text(
                                                    playerOfTheMonthStatsAndInfoNotifier.playerOfTheMonthStatsAndInfoList[index].goalsConcededGkDef
                                                        .toString(),
                                                    style: GoogleFonts.rubikMicrobe(
                                                        color: dialogColor, fontSize: 20, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic),
                                                  ),
                                                ),
                                              ),
                                              Padding(
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: SizedBox(
                                                  width: MediaQuery.of(context).size.width * 0.35,
                                                  child: Text(
                                                    playerOfTheMonthStatsAndInfoNotifier.playerOfTheMonthStatsAndInfoList[index].cleanSheetGk
                                                        .toString(),
                                                    style: GoogleFonts.rubikMicrobe(
                                                        color: dialogColor, fontSize: 20, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic),
                                                  ),
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: SizedBox(
                                                  width: MediaQuery.of(context).size.width * 0.35,
                                                  child: Text(
                                                    playerOfTheMonthStatsAndInfoNotifier.playerOfTheMonthStatsAndInfoList[index].matchesPlayed
                                                        .toString(),
                                                    style: GoogleFonts.rubikMicrobe(
                                                        color: dialogColor, fontSize: 20, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic),
                                                  ),
                                    ...
                                    ] else if (playerOfTheMonthStatsAndInfoNotifier.playerOfTheMonthStatsAndInfoList[index].playerPosition
                                                .toString()
                                                .toLowerCase() ==
                                            'cb' ||
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: SizedBox(
                                                  width: MediaQuery.of(context).size.width * 0.35,
                                                  child: Text(
                                                    playerOfTheMonthStatsAndInfoNotifier.playerOfTheMonthStatsAndInfoList[index].goalsScored
                                                        .toString(),
                                                    style: GoogleFonts.rubikMicrobe(
                                                        color: dialogColor, fontSize: 20, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic),
                                                  ),
                                        ...
                                        Padding(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Text(
                                              presentedByTitle,
                                              style: GoogleFonts.arimo(
                                                  color: containerColor, fontSize: 14, fontWeight: FontWeight.w200, fontStyle: FontStyle.italic),
                                              textAlign: TextAlign.center,
                                            ),
                                          ),
                                        ),
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: Text(
                                                playerOfTheMonthStatsAndInfoNotifier.playerOfTheMonthStatsAndInfoList[index].playerName!
                                                    .replaceAll(" ", "\n"),
                                                style: GoogleFonts.rubikMicrobe(
                                                    color: dialogColor, fontSize: 25, fontWeight: FontWeight.bold, height: 0.81),
                                                overflow: TextOverflow.ellipsis,
                                              ),
                                            ),
                                          ),
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: Text(
                                                    playerOfTheMonthStatsAndInfoNotifier.playerOfTheMonthStatsAndInfoList[index].goalsConcededGkDef
                                                        .toString(),
                                                    style: GoogleFonts.rubikMicrobe(
                                                        color: dialogColor, fontSize: 30, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic),
                                                  ),
                                                ),
                                              ),
                                              Padding(
  ...
  initState() {
    ...
    Future.wait([
      ...
      _fetchMostFouledYCPlayersStatsAndUpdateNotifier(mostFouledYCPlayersStatsAndInfoNotifier),
      _fetchMostFouledRCPlayersStatsAndUpdateNotifier(mostFouledRCPlayersStatsAndInfoNotifier),
      _fetchPlayerOfTheMonthStatsAndUpdateNotifier(playerOfTheMonthStatsAndInfoNotifier),
      _fetchTopGKPlayersStatsAndUpdateNotifier(topGKPlayersStatsAndInfoNotifier),
      _fetchTopDefensivePlayersStatsAndUpdateNotifier(topDefensivePlayersStatsAndInfoNotifier),
      _fetchMOTMPlayersStatsAndUpdateNotifier(motmPlayersStatsAndInfoNotifier),
