...
Color modalIconColor = Colors.white70;
Color modalTextColor = Colors.white70;
...
Color nabColor = const Color.fromRGBO(22, 37, 47, 1.0);

class MyCoachesPage extends StatefulWidget implements NavigationStates {
  final String clubId;
  const MyCoachesPage({super.key, this.title, required this.clubId});
...
class _MyCoachesPage extends State<MyCoachesPage> {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        ...
                        image: CachedNetworkImageProvider(coachesNotifier.coachesList[index].image!),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(coachesNotifier.coachesList[index].staffPosition!,
  ...
  Future navigateToCoachesDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => CoachesDetailsPage(clubId: widget.clubId)));
  }
    ...
    return PopScope(
      ...
      child: Scaffold(
                  ...
                  actions: <Widget>[
                                        ...
                                        child: Wrap(
                                          children: <Widget>[
                                            ListTile(
                                                ...
                                                title: Text(
                                                  clubAdmin,
                                                  style: GoogleFonts.zillaSlab(color: modalTextColor),
                                                ),
                                                onTap: () {
                                                  Navigator.of(context).pop(false);
                                            ...
                                            //     }),
                                            ListTile(
                                              leading: Icon(MdiIcons.accountGroup, color: modalIconColor),
                                              title: Text(
                                                aboutClub,
                                                style: GoogleFonts.zillaSlab(color: modalTextColor),
                                              ),
                                            ...
                                            ListTile(
                                                leading: Icon(MdiIcons.sortAlphabeticalAscending, color: modalIconColor),
                                                title: Text(
                                                  acronymMeanings,
                                                  style: GoogleFonts.zillaSlab(color: modalTextColor),
                                                ),
                                            ...
                                            ListTile(
                                              leading: Icon(MdiIcons.opacity, color: modalIconColor),
                                              title: Text(
                                                aboutApp,
                                                style: GoogleFonts.zillaSlab(color: modalTextColor),
                                              ),
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        showSearch(
                          context: context,
                          delegate: MyCoachesSearch(all: coachesNotifier.coachesList, clubId: widget.clubId),
                        );
                      },
                      tooltip: "Search",
                    ),
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: Text(
            fabStats,
            style: TextStyle(color: iconColorTwo),
          ),
