...
class MyClubSponsorsPage extends StatefulWidget implements NavigationStates {
  ...
  @override
  State<MyClubSponsorsPage> createState() => MyClubSponsorsPageState();
}

class MyClubSponsorsPageState extends State<MyClubSponsorsPage> with SingleTickerProviderStateMixin {
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        ...
                        if (widget.fromPage1) {
                          Navigator.pushReplacement(context, SlideTransition1(MyClubAdminPage(clubId: widget.clubId)));
                        } else {
