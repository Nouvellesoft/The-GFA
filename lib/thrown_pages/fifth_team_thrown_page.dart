...
import '../thrown_searches/fifth_team_thrown_search.dart';

String clubName = "";
// String thrownName = "All Players List - uu";
String thrownName = "Fifth Team Players";
...
Color modalBackgroundColor = const Color.fromRGBO(33, 28, 33, 1.0);
Color materialBackgroundColor = Colors.transparent;
Color splashColor = const Color.fromRGBO(33, 28, 33, 1.0);
...
Color dialogBackgroundColor = const Color.fromRGBO(33, 28, 33, 1.0);
...
class MyFifthTeamClassPage extends StatefulWidget implements NavigationStates {
  final String clubId;
  const MyFifthTeamClassPage({super.key, this.title, required this.clubId});

  final String? title;

  @override
  State<MyFifthTeamClassPage> createState() => _MyFifthTeamClassPage();
}

class _MyFifthTeamClassPage extends State<MyFifthTeamClassPage> {
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            onTap: () {
              fifthTeamClassNotifier.currentFifthTeamClass = fifthTeamClassNotifier.fifthTeamClassList[index];
              navigateToFifthTeamClassDetailsPage(context);
            },
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            ...
                            image: CachedNetworkImageProvider(fifthTeamClassNotifier.fifthTeamClassList[index].image!),
                            fit: BoxFit.cover)),
                  ),
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text(fifthTeamClassNotifier.fifthTeamClassList[index].name!,
                                  style: GoogleFonts.tenorSans(color: textColorTwo, fontSize: 17, fontWeight: FontWeight.w600)),
                              (() {
                                if (fifthTeamClassNotifier.fifthTeamClassList[index].captain == "Yes") {
                                  return Row(
                                    children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(fifthTeamClassNotifier.fifthTeamClassList[index].positionPlaying!,
  ...
  Future navigateToFifthTeamClassDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => FifthTeamClassDetailsPage(clubId: widget.clubId)));
  }
                  ...
                  actions: <Widget>[
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        showSearch(
                          context: context,
                          delegate: MyFifthTeamClassSearch(all: fifthTeamClassNotifier.fifthTeamClassList, clubId: widget.clubId),
                        );
                      },
                      tooltip: "Search",
                    ),
            ...
            body: Padding(
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: fifthTeamClassNotifier.fifthTeamClassList.length,
                ),
              ),
            ),
          ),
