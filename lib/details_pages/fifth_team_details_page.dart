...
Color backgroundColor = const Color.fromRGBO(33, 28, 33, 1.0);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = const Color.fromRGBO(33, 28, 33, 1.0);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = const Color.fromRGBO(33, 28, 33, 1.0);
Color shapeDecorationColorTwo = const Color.fromRGBO(33, 28, 33, 1.0);
Color shapeDecorationTextColor = const Color.fromRGBO(33, 28, 33, 1.0);
Color shapeDecorationIconColor = const Color.fromRGBO(33, 28, 33, 1.0);
...
Color iconTextColorTwo = const Color.fromRGBO(33, 28, 33, 1.0);
Color buttonColor = const Color.fromRGBO(33, 28, 33, 1.0);
Color textColor = const Color.fromRGBO(33, 28, 33, 1.0);
...
late FifthTeamClassNotifier fifthTeamClassNotifier;
...
class FifthTeamClassDetailsPage extends StatefulWidget {
  final String clubId;
  const FifthTeamClassDetailsPage({super.key, this.title, required this.clubId});

  final String? title;

  @override
  State<FifthTeamClassDetailsPage> createState() => _FifthTeamClassDetailsPage();
}

class _FifthTeamClassDetailsPage extends State<FifthTeamClassDetailsPage> {
  ...
  Future<void> _submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      String collectionName = 'FifthTeamClassPlayers';
  ...
  Future<void> uploadImagesToStorageAndFirestore(List<File> imageFiles) async {
    try {
      ...
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('clubs').doc(widget.clubId).collection('FifthTeamClassPlayers').get();
      ...
      if (documentId != null) {
        for (int i = 0; i < imageFiles.length; i++) {
          ...
          await FirebaseFirestore.instance.collection('clubs').doc(widget.clubId).collection('FifthTeamClassPlayers').doc(documentId).update({
            imageField: imageUrl,
          });
        }
        // Show success toast
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            fifthTeamClassNotifier.currentFifthTeamClass.nickname!,
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              if (fifthTeamClassNotifier.currentFifthTeamClass.imageTwo.toString().isEmpty) ...[
                Tooltip(
                    message: fifthTeamClassNotifier.currentFifthTeamClass.name,
                        ...
                        child: Card(
                          ...
                          child: AnimatedCrossFade(
                            ...
                            firstChild: CachedNetworkImage(
                              imageUrl: fifthTeamClassNotifier.currentFifthTeamClass.image!,
                              fit: BoxFit.cover,
                      ...
                      child: SizedBox(
                        ...
                        child: Card(
                          ...
                          child: AnimatedCrossFade(
                            ...
                            secondChild: CachedNetworkImage(
                              imageUrl: fifthTeamClassNotifier.currentFifthTeamClass.imageTwo!,
                              fit: BoxFit.cover,
                              placeholder: (context, url) => const CircularProgressIndicator(),
                              errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                            ),
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              fifthTeamClassNotifier.currentFifthTeamClass.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (fifthTeamClassNotifier.currentFifthTeamClass.captain == "Yes") {
                                return Row(
                                  children: <Widget>[
  ...
  initState() {
    ...
    _autoBio = fifthTeamClassNotifier.currentFifthTeamClass.autoBio;
    _bestMoment = fifthTeamClassNotifier.currentFifthTeamClass.bestMoment;
    _dob = fifthTeamClassNotifier.currentFifthTeamClass.dob;
    _dreamFC = fifthTeamClassNotifier.currentFifthTeamClass.dreamFC;
    _positionPlaying = fifthTeamClassNotifier.currentFifthTeamClass.positionPlaying;
    _email = fifthTeamClassNotifier.currentFifthTeamClass.email;
    _facebook = fifthTeamClassNotifier.currentFifthTeamClass.facebook;
    _linkedIn = fifthTeamClassNotifier.currentFifthTeamClass.linkedIn;
    _hobbies = fifthTeamClassNotifier.currentFifthTeamClass.hobbies;
    _instagram = fifthTeamClassNotifier.currentFifthTeamClass.instagram;
    _myDropline = fifthTeamClassNotifier.currentFifthTeamClass.myDropline;
    _name = fifthTeamClassNotifier.currentFifthTeamClass.name;
    _nickname = fifthTeamClassNotifier.currentFifthTeamClass.nickname;
    _philosophy = fifthTeamClassNotifier.currentFifthTeamClass.philosophy;
    _phone = fifthTeamClassNotifier.currentFifthTeamClass.phone;
    _captain = fifthTeamClassNotifier.currentFifthTeamClass.captain;
    _prefectPosition = fifthTeamClassNotifier.currentFifthTeamClass.teamCaptaining;
    _country = fifthTeamClassNotifier.currentFifthTeamClass.constituentCountry;
    _regionFrom = fifthTeamClassNotifier.currentFifthTeamClass.regionFrom;
    _twitter = fifthTeamClassNotifier.currentFifthTeamClass.twitter;
    _snapchat = fifthTeamClassNotifier.currentFifthTeamClass.snapchat;
    _tikTok = fifthTeamClassNotifier.currentFifthTeamClass.tikTok;
    _otherPositionsOfPlay = fifthTeamClassNotifier.currentFifthTeamClass.otherPositionsOfPlay;
    _favFootballLegend = fifthTeamClassNotifier.currentFifthTeamClass.favFootballLegend;
    _yearOfInception = fifthTeamClassNotifier.currentFifthTeamClass.yearOfInception;
    _leftOrRightFooted = fifthTeamClassNotifier.currentFifthTeamClass.leftOrRightFooted;
    _adidasOrNike = fifthTeamClassNotifier.currentFifthTeamClass.adidasOrNike;
    _ronaldoOrMessi = fifthTeamClassNotifier.currentFifthTeamClass.ronaldoOrMessi;
    _worstMoment = fifthTeamClassNotifier.currentFifthTeamClass.worstMoment;
