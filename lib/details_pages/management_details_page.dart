...
Color shapeDecorationColor = const Color.fromRGBO(56, 56, 60, 1);
Color shapeDecorationColorTwo = const Color.fromRGBO(56, 56, 60, 1);
Color shapeDecorationTextColor = const Color.fromRGBO(56, 56, 60, 1);
Color shapeDecorationIconColor = const Color.fromRGBO(56, 56, 60, 1);
Color cardBackgroundColor = Colors.white;
Color cardBackgroundColorTwo = const Color.fromRGBO(56, 56, 60, 1);
Color splashColor = const Color.fromRGBO(56, 56, 60, 1);
Color splashColorTwo = const Color.fromRGBO(56, 56, 60, 1);
Color splashColorThree = const Color.fromRGBO(56, 56, 60, 1);
Color iconTextColor = const Color.fromRGBO(56, 56, 60, 1);
Color buttonColor = Colors.white60;
Color textColor = const Color.fromRGBO(56, 56, 60, 1);
        ...
        content: Column(
          ...
          children: [
            TextField(
              ...
              decoration: const InputDecoration(
                hintText: 'The performances of the players this past 3 weeks have been phenomenal.',
                hintStyle: TextStyle(
