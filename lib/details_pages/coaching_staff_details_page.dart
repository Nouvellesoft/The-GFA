...
Color shapeDecorationColor = const Color.fromRGBO(22, 37, 47, 1.0);
Color shapeDecorationColorTwo = const Color.fromRGBO(22, 37, 47, 1.0);
Color shapeDecorationTextColor = const Color.fromRGBO(22, 37, 47, 1.0);
Color shapeDecorationTextColorTwo = const Color.fromRGBO(22, 37, 47, 1.0);
...
Color splashColorThree = const Color.fromRGBO(22, 37, 47, 1.0);
Color iconTextColor = const Color.fromRGBO(22, 37, 47, 1.0);
Color buttonColor = const Color.fromRGBO(22, 37, 47, 1.0);
Color textColor = const Color.fromRGBO(22, 37, 47, 1.0);
...
class CoachesDetailsPage extends StatefulWidget {
  final String clubId;
  const CoachesDetailsPage({super.key, this.title, required this.clubId});
...
class _CoachesDetailsPage extends State<CoachesDetailsPage> {
  ...
  Future<void> uploadImagesToStorageAndFirestore(List<File> imageFiles) async {
    try {
      ...
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('clubs').doc(widget.clubId).collection('Coaches').get();
      ...
      if (documentId != null) {
        for (int i = 0; i < imageFiles.length; i++) {
          ...
          final Reference storageReference = FirebaseStorage.instance.ref().child('${widget.clubId}/coaches').child(queryName).child(imageName);
          ...
          await FirebaseFirestore.instance.collection('clubs').doc(widget.clubId).collection('Coaches').doc(documentId).update({
            imageField: imageUrl,
          });
        }
        // Show success toast
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (commentDescription.isNotEmpty) {
                  ...
                  await FirebaseFirestore.instance.collection('clubs').doc(widget.clubId).collection('CoachesMonthlyComments').add({
