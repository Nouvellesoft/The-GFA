...
Color backgroundColor = const Color.fromRGBO(38, 37, 32, 1.0);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = const Color.fromRGBO(38, 37, 32, 1.0);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = const Color.fromRGBO(38, 37, 32, 1.0);
Color shapeDecorationColorTwo = const Color.fromRGBO(38, 37, 32, 1.0);
Color shapeDecorationTextColor = const Color.fromRGBO(38, 37, 32, 1.0);
Color shapeDecorationIconColor = const Color.fromRGBO(38, 37, 32, 1.0);
...
Color iconTextColorTwo = const Color.fromRGBO(38, 37, 32, 1.0);
Color buttonColor = const Color.fromRGBO(38, 37, 32, 1.0);
Color textColor = const Color.fromRGBO(38, 37, 32, 1.0);
...
late SixthTeamClassNotifier sixthTeamClassNotifier;
...
class SixthTeamClassDetailsPage extends StatefulWidget {
  final String clubId;
  const SixthTeamClassDetailsPage({super.key, this.title, required this.clubId});

  final String? title;

  @override
  State<SixthTeamClassDetailsPage> createState() => _SixthTeamClassDetailsPage();
}

class _SixthTeamClassDetailsPage extends State<SixthTeamClassDetailsPage> {
  ...
  Future<void> _submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      String collectionName = 'SixthTeamClassPlayers';
  ...
  Future<void> uploadImagesToStorageAndFirestore(List<File> imageFiles) async {
    try {
      ...
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('clubs').doc(widget.clubId).collection('SixthTeamClassPlayers').get();
      ...
      if (documentId != null) {
        for (int i = 0; i < imageFiles.length; i++) {
          ...
          await FirebaseFirestore.instance.collection('clubs').doc(widget.clubId).collection('SixthTeamClassPlayers').doc(documentId).update({
            imageField: imageUrl,
          });
        }
        // Show success toast
  ...
  Widget build(BuildContext context) {
    ...
    sixthTeamClassNotifier = Provider.of<SixthTeamClassNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            sixthTeamClassNotifier.currentSixthTeamClass.nickname!,
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              if (sixthTeamClassNotifier.currentSixthTeamClass.imageTwo.toString().isEmpty) ...[
                Tooltip(
                    message: sixthTeamClassNotifier.currentSixthTeamClass.name,
                        ...
                        child: Card(
                          ...
                          child: AnimatedCrossFade(
                            ...
                            firstChild: CachedNetworkImage(
                              imageUrl: sixthTeamClassNotifier.currentSixthTeamClass.image!,
                              fit: BoxFit.cover,
                      ...
                      child: SizedBox(
                        ...
                        child: Card(
                          ...
                          child: AnimatedCrossFade(
                            ...
                            secondChild: CachedNetworkImage(
                              imageUrl: sixthTeamClassNotifier.currentSixthTeamClass.imageTwo!,
                              fit: BoxFit.cover,
                              placeholder: (context, url) => const CircularProgressIndicator(),
                              errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                            ),
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              sixthTeamClassNotifier.currentSixthTeamClass.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (sixthTeamClassNotifier.currentSixthTeamClass.captain == "Yes") {
                                return Row(
                                  children: <Widget>[
  ...
  initState() {
    ...
    _autoBio = sixthTeamClassNotifier.currentSixthTeamClass.autoBio;
    _bestMoment = sixthTeamClassNotifier.currentSixthTeamClass.bestMoment;
    _dob = sixthTeamClassNotifier.currentSixthTeamClass.dob;
    _dreamFC = sixthTeamClassNotifier.currentSixthTeamClass.dreamFC;
    _positionPlaying = sixthTeamClassNotifier.currentSixthTeamClass.positionPlaying;
    _email = sixthTeamClassNotifier.currentSixthTeamClass.email;
    _facebook = sixthTeamClassNotifier.currentSixthTeamClass.facebook;
    _linkedIn = sixthTeamClassNotifier.currentSixthTeamClass.linkedIn;
    _hobbies = sixthTeamClassNotifier.currentSixthTeamClass.hobbies;
    _instagram = sixthTeamClassNotifier.currentSixthTeamClass.instagram;
    _myDropline = sixthTeamClassNotifier.currentSixthTeamClass.myDropline;
    _name = sixthTeamClassNotifier.currentSixthTeamClass.name;
    _nickname = sixthTeamClassNotifier.currentSixthTeamClass.nickname;
    _philosophy = sixthTeamClassNotifier.currentSixthTeamClass.philosophy;
    _phone = sixthTeamClassNotifier.currentSixthTeamClass.phone;
    _captain = sixthTeamClassNotifier.currentSixthTeamClass.captain;
    _prefectPosition = sixthTeamClassNotifier.currentSixthTeamClass.teamCaptaining;
    _country = sixthTeamClassNotifier.currentSixthTeamClass.constituentCountry;
    _regionFrom = sixthTeamClassNotifier.currentSixthTeamClass.regionFrom;
    _twitter = sixthTeamClassNotifier.currentSixthTeamClass.twitter;
    _snapchat = sixthTeamClassNotifier.currentSixthTeamClass.snapchat;
    _tikTok = sixthTeamClassNotifier.currentSixthTeamClass.tikTok;
    _otherPositionsOfPlay = sixthTeamClassNotifier.currentSixthTeamClass.otherPositionsOfPlay;
    _favFootballLegend = sixthTeamClassNotifier.currentSixthTeamClass.favFootballLegend;
    _yearOfInception = sixthTeamClassNotifier.currentSixthTeamClass.yearOfInception;
    _leftOrRightFooted = sixthTeamClassNotifier.currentSixthTeamClass.leftOrRightFooted;
    _adidasOrNike = sixthTeamClassNotifier.currentSixthTeamClass.adidasOrNike;
    _ronaldoOrMessi = sixthTeamClassNotifier.currentSixthTeamClass.ronaldoOrMessi;
    _worstMoment = sixthTeamClassNotifier.currentSixthTeamClass.worstMoment;
