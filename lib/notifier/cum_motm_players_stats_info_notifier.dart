...
class CumMOTMPlayersStatsAndInfoNotifier with ChangeNotifier {
  ...
  UnmodifiableListView<PlayersStatsAndInfo>
      get cumMOTMPlayersStatsAndInfoList =>
          UnmodifiableListView(_cumMOTMPlayersStatsAndInfoList);

  PlayersStatsAndInfo get currentCumMOTMPlayersStatsAndInfo =>
      _currentCumMOTMPlayersStatsAndInfo;

  set cumMOTMPlayersStatsAndInfoList(
      List<PlayersStatsAndInfo> cumMOTMPlayersStatsAndInfoList) {
    _cumMOTMPlayersStatsAndInfoList = cumMOTMPlayersStatsAndInfoList;
    notifyListeners();
  }

  set currentCumMOTMPlayersStatsAndInfo(
