...
Color gradientColorFour = const Color.fromRGBO(71, 141, 222, 1.0);
...
class _SideBarState extends State<SideBar> with SingleTickerProviderStateMixin<SideBar> {
  ...
  bool _isChatGFAClicked = false; // New variable to track the "ChatGFA" click
  ...
  _onSelected(int index) {
    ...
    if (index == 9 /**|| index == 8 */) {
      // Check if the selected item is "ChatGFA"
      _isChatGFAClicked = true;
      // showToast("ChatGFA Clicked"); // Show the toast message
    } else {
      _isChatGFAClicked = false;
    }
  ...
  final GlobalKey _animatedIconKeyShowcaser = GlobalKey();
  final GlobalKey _askChatGFAKeyShowcaser = GlobalKey();
  ...
  void onIconPressed() {
    ...
    if (isAnimationCompleted) {
      ...
      if (kDebugMode) {
        print("Sidebar is opened");
      } // Log when sidebar is opened
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<FTClassOkayDialogButtonPressedNotifier, bool>(
        selector: (_, notifier) => notifier.isOkayDialogButtonPressed,
        builder: (context, isOkayPressed, child) {
          if (!sideBarNotifier.isOpened && isOkayPressed) {
            WidgetsBinding.instance.addPostFrameCallback((_) {
              if (mounted) {
                ShowCaseWidget.of(context).startShowCase([
                  _animatedIconKeyShowcaser,
                  _askChatGFAKeyShowcaser,
                ]);
                // Reset the flag to prevent future triggers
                Provider.of<FTClassOkayDialogButtonPressedNotifier>(context, listen: false).setOkayPressed(false);
              }
            });
          }
          ...
          return StreamBuilder<bool>(
            ...
            builder: (context, isSidebarOpenedAsync) {
              return Visibility(
                visible: !(_isClubSponsorsClicked || _isChatGFAClicked), // Hide the sidebar when "Club Sponsors" is clicked,
                child: AnimatedPositioned(
                  ...
                  child: Row(
                    children: <Widget>[
                          ...
                          child: Align(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  gradient:
                                      LinearGradient(begin: Alignment.topRight, end: Alignment.bottomLeft, colors: [gradientColor, gradientColor])),
                                  ...
                                  children: <Widget>[
                                                        ...
                                                        child: ListTile(
                                                          title: Text(
                                                            ...
                                                            style: GoogleFonts.gorditas(
                                                                ...
                                                                shadows: <Shadow>[
                                                                  Shadow(
                                                                      blurRadius: 50, color: textShadowColor, offset: Offset.fromDirection(100, 12))
                                                                ]),
                                                          ),
                                                          subtitle: Text(
                                                            sidebarSubtitle,
                                    ...
                                    FutureBuilder<Map<String, Map<String, dynamic>>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final String thirdTeamClassTitle =
                                            teamData['ThirdTeamClass']?['title'] as String? ?? defaultThirdTeamClassTitle;
                                        final String fourthTeamClassTitle =
                                            teamData['FourthTeamClass']?['title'] as String? ?? defaultFourthTeamClassTitle;
                                        final String fifthTeamClassTitle =
                                            teamData['FifthTeamClass']?['title'] as String? ?? defaultFifthTeamClassTitle;
                                        final String sixthTeamClassTitle =
                                            teamData['SixthTeamClass']?['title'] as String? ?? defaultSixthTeamClassTitle;
                                    ...
                                    Showcase(
                                      key: _askChatGFAKeyShowcaser,
                                      description: "Click here to use ChatGFA",
                                      disposeOnTap: true, // Ensure the showcase doesn't close on tap
                                      onTargetClick: () {
                                        onIconPressed();
                                      },
                                      onBarrierClick: () {
                                      ...
                                      child: Material(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () {
                                            ...
                                            _onSelected(9);
                                            onIconPressed();
                                            BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myChatGFAPageClickedEvent);
                                          },
                                          child: Align(
                                    ...
                                    Theme(
                                        ...
                                        child: ExpansionTile(
                                            ...
                                            children: <Widget>[
                                              Material(
                                                color:
                                                    _currentNAVSelected == 11 ? containerBackgroundColor.withOpacity(0.3) : materialBackgroundColor,
                                                child: InkWell(
                                              ...
                                              Material(
                                                color:
                                                    _currentNAVSelected == 12 ? containerBackgroundColor.withOpacity(0.3) : materialBackgroundColor,
                                                child: InkWell(
                                                  splashColor: splashColorTwo,
                                                  onTap: () {
                                                    _onSelected(12);
                                              ...
                                              Material(
                                                color:
                                                    _currentNAVSelected == 13 ? containerBackgroundColor.withOpacity(0.3) : materialBackgroundColor,
                                                child: InkWell(
                                                  splashColor: splashColorTwo,
                                                  onTap: () {
                                                    _onSelected(13);
                                              ...
                                              Material(
                                                color:
                                                    _currentNAVSelected == 14 ? containerBackgroundColor.withOpacity(0.3) : materialBackgroundColor,
                                                child: InkWell(
                                                  splashColor: splashColorTwo,
                                                  onTap: () {
                                                    _onSelected(14);
                      ...
                      // First Showcase: Sidebar Toggle
                      Align(
                        alignment: const Alignment(-0.1, -0.9),
                        child: Showcase(
                          key: _animatedIconKeyShowcaser,
                          description: "Click here to open or close the sidebar",
                          onTargetClick: () {
                            print('i am working');
                            ShowCaseWidget.of(context).next(); // Move to next showcase
                          },
                          disposeOnTap: false, // Ensure the showcase doesn't close on tap
                          child: GestureDetector(
                            onTap: () async {
                              ...
                              // widget.triggerFabShowcaseCallback(context); // Trigger the FAB showcase from the sidebar
                            },
                            child: ClipPath(
                              ...
                              child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: AnimatedIcon(
                                    ...
                                    icon:
                                        _animationController.status == AnimationStatus.completed ? AnimatedIcons.menu_home : AnimatedIcons.close_menu,
